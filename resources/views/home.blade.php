            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-lg mb-0 text-capitalize">Despesas</p>
                            <?php $valorDesp = 0;?>
                            <h4 class="mb-0"> @foreach ($despesas as $despesa)
                                <?php  $valorDesp += $despesa->eletrecidade + $despesa->agua + $despesa->consumiveis + $despesa->manutencao + $despesa->equipamentos + $despesa->outras?>
