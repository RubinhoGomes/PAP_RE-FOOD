        ...
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
              <h6 class="text-white text-capitalize ps-3">Rotas</h6>
            </div>
          </div>
          <div class="card-body px-0 pb-2">
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-9">Motorista</th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-9">Carrinha</th>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-9">Kilométros Percoridos</th>
...
{{--                            <img src="../assets/img/team-2.jpg" class="avatar avatar-sm me-3 border-radius-lg" alt="user1"> --}}
                       ...
                       <td>
                        ...
                        <td class="align-middle text-center text-sm">
                          <span class="text-secondary text-center text-xs font-weight-bold{{-- badge badge-sm bg-gradient-success --}}">{{ ($rota->kmChegada - $rota->kmPartida) }}</span>
                        </td>
                        ...
                        <td class="align-middle text-left">
                            {{--Botão Remover --}}
                             <form role="form" action="/rotas/{{ $rota->id }}" method="post">
                                @csrf
                                @method('DELETE')
